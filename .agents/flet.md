...
*   **Service-Only Plugins**: Plugins που λειτουργούν ως background services (όπως το `Audio` and το `PermissionHandler`) **ΔΕΝ ΠΡΕΠΕΙ** να προστίθενται στο `page.overlay` (προκαλεί σφάλμα "Unknown control").
